    ...
    <div class="col-md-9">
        ...
        <div class="ibox">
            ...
            <div class="ibox-content text-right">
                ...
                <button class="btn btn-warning btn-sm bayar_sekarang"><i class="fa fa fa-money-bill-alt"></i> Bayar</button>
    ...
    <div class="col-md-3">
        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <div class="m-t-sm">
                    <div class="btn-group">
                    <a href="#" class="btn btn-warning btn-sm bayar_sekarang" id="btn-confirm"><i class="fa fa-money-bill-alt"></i> Bayar</a>
