                            ...
                            <div class="col-md-5">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption" style="padding:0 15px;">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" class="checkbox-lamar" name="tunai" id="tunai"
                                                   value="Y">
                                            ...
                                            <div class="row column-group-cart-item-product">
                                                <div class="col-lg-8 col-md-7 column-left-cart-item-product">
                                                    ...
                                                    <div class="column-description-cart-product">
                                                        ...
                                                        <input type="hidden" value="<?php echo e($row->cart_location); ?>"
                                                               name="gudang[]">
                                                        <input type="text" value="<?php echo e($row->ipr_sunitprice); ?>"
                                                               name="hargabarang[]"
                                                               hidden>
                                                        <input type="hidden"
                                                        ...
                                                        <div class="input-group d-flex">
                                                            <button class="btn btn-default btn-sm btn-count-item border-right-0"
                                                                    type="button" disabled><i class="fa fa-minus"></i>
                                                            </button>
                                                            <input type="number" class="form-control text-center"
                                                                   value="<?php echo e($row->cart_qty); ?>"
                                                                   aria-describedby="sizing-addon2"
                                                                   readonly>
                                                            <button class="btn btn-default btn-sm btn-count-item border-left-0"
                                                                    type="button" disabled><i class="fa fa-plus"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
