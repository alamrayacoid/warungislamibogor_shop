...
<nav class="navbar navbar_custom not-login">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="padding-right:0;">
            ...
            <form class="navbar-form navbar-left form-header-login" action="<?php echo e(route('produk-frontpage')); ?>"
            ...
            <ul class="nav navbar-nav navbar-right btn-group-header">
                <li class="nav-link border-0"><a href="<?php echo e(route('login-frontpage')); ?>"><button class="btn btn-login-header mr-3">Masuk</button></a>
                </li>
                ...
                <li class="dropdown nav-link">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false"><i class="fa fa-user"></i><span
                            class="text-name-header"><?php echo e(Auth::user()->cm_name); ?></span><span class="caret" style="position:relative;top:-0.1em;"></span></a>
                    <ul class="dropdown-menu dropdown-menu-user">
