                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="media-footer-group">
                        <div class="media-footer-image">
                            <img src="<?php echo e(asset('assets/img/icon-garansi.png')); ?>">
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3">
                ...
                <ul class="list-bank">
                    ...
                    <li><img src="<?php echo e(asset('assets/img/icon/icon-sicepat.png')); ?>" alt="SICEPAT"></li>
                    <li><img src="<?php echo e(asset('assets/img/icon/icon-j&t.jpg')); ?>" alt="J&T"></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-3">
                ...
                <ul class="list-bank">
                    ...
                    <li><img src="<?php echo e(asset('assets/img/icon/icon-bca.jpg')); ?>" alt="BCA"></li>
                    <li><img src="<?php echo e(asset('assets/img/icon/icon-mandiri.jpg')); ?>" alt="Mandiri"></li>
                </ul>
            </div>
        </div>
