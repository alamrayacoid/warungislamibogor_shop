                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-right">
                                            ...
                                            <a data-target="#modal-detail" data-id="{{$row->sell_nota}}"
                                                ...
                                                data-totalb="{{$row->totalbeli}}" data-hargat="Rp. {{$row->sell_total}}"
                                                    ...
                                                    <td class="desc" style="width: 50%">
                                                        ...
                                                        <div class="m-t-sm">
                                                            <span class="text-warning">Rp.
                                                                {{$roww->ipr_sunitprice}}</span>
                                                            |
                                                            <span class="text-muted">{{$roww->sell_quantity}}
                                                                Produk</span>
                                                        </div>
                                                    </td>
                                ...
                                <div class="ibox-title ibox-produk-title">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-right">
                                            ...
                                            <br>
                                            <button class="btn btn-warning btn-sm bayar" data-nota="{{$row->sell_nota}}"
