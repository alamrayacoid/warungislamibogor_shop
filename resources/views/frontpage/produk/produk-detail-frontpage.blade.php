                                        ...
                                        <div class="product-images product-imitations" style="outline:none;border:0;">
                                            @foreach($gambar as $roww)
                                                @if($roww->ip_ciproduct)
                                                    <div>
                                                        <a href="{{env('APP_WIB')}}storage/image/master/produk/{{$roww->ip_path}}"
                                                           sty
                                                           data-gallery="">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="m-t-md">
                                                    @if($row->gpp_sellprice == null)
                                                        <h2 class="product-detail-price">Rp. {{$row->ipr_sunitprice}}
                                                            <small
                                                    ...
                                                    @else
                                                        ...
                                                        <h2 class="product-detail-price">Rp. {{$row->gpp_sellprice}}
                                                            <small
                                                                    class="text-info-price">Tidak Termasuk Pajak
                                                                pengiriman
                                                            </small>
                                                        ...
                                                        <div class="col-md-6 p-detail-product-first">
                                                            @if($wish > 0)
                                                                <button class="btn btn-product-detail-wishlist addwishlist"
                                                                        style="color:#676a6c;" data-ciproduct="{{$row->i_code}}" id="{{$row->i_code}}" type="button"><i
