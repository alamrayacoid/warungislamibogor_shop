<style>
     ...
     */
    .home-welcome {
      /*background-image: linear-gradient(45deg, #145648, #1AB394);
      background-image: -webkit-linear-gradient(45deg, #145648, #1AB394);
      background-image: -moz-linear-gradient(45deg, #145648, #1AB394);
      background-image: -ms-linear-gradient(45deg, #145648, #1AB394);
      background-image: -o-linear-gradient(45deg, #145648, #1AB394);
*/      
      /*color: white;*/
      padding: 2em 0 2em;
      font-size: 150%;
